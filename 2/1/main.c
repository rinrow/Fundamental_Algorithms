...
int main() {
    ...
    operate(out, 6, 3, 0.3, 0.5, 0.9999);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    operate(out, 7, n, 0.3, 0.5);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    operate(out, 10, n, 0.3, 0.42);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    operate(out, 2, n, 0.1, 0.67);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    operate(out, 3, 0);
    ...
    operate(out, 5, n, 0.2, 0.111111111111111111111);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    operate(out, 10, n, 0.3, 0.000000000000000000000000001);
    for(int i = 0; i < n; ++i) {
        printf("число по номеру %d, %s имеет конеч предс\n", i + 1, out[i] ? "": "не");
    }
    return 0;
